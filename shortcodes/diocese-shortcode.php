...
';
    ...
    <div id="<?php echo esc_attr($uniq); ?>_sidebar" class="jso-sidebar hidden">
        ...
        <div class="drawer shadow-xl">
            <div class="flex items-center justify-between p-4 border-b bg-white sticky top-0 z-[100]">
                ...
                <h3 id="<?php echo esc_attr($uniq); ?>_sidebar_title" class="text-lg font-semibold text-gray-900 w-[290px]">
                    List</h3>
            </div>
    ...
    <!-- <div id="<?php echo $uniq; ?>_modal"
        ...
        <!-- Modal -->
        <!-- <div id="<?php echo esc_attr($uniq); ?>_modal" class="jso-modal fixed inset-0 hidden items-center justify-center">
            ...
            <div class="modal-box bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
                ...
                <div class="mt-6 flex gap-4 items-center">
                    <img id="<?php echo esc_attr($uniq); ?>_modal_image" class="w-12 h-12 rounded-full object-cover" />
                    <div>
        ...
        <div id="<?php echo esc_attr($uniq); ?>_modal" class="jso-modal fixed flex hidden inset-0 bg-black bg-opacity-50  items-center justify-center z-50">
            <div class="bg-white rounded-xl p-6 w-full max-w-md shadow-xl relative">
                <button
                    class="jso-close-modal absolute top-3 right-3 p-3 text-2xl font-bold text-gray-600 hover:text-black p-10 bg-[#808080] rounded-full">&times;</button>
                <div class="flex justify-center mb-6">
                    <img id="<?php echo esc_attr($uniq); ?>_modal_image" class="w-24 h-24 rounded-full object-cover bg-gray-100" />
                    </div>
                    <div class="mt-4 gap-4">
                        <h4 id="<?php echo esc_attr($uniq); ?>_modal_title" class="text-lg font-semiboldtext-xl font-semibold text-gray-900 text-center"></h4>
                        <p id="<?php echo esc_attr($uniq); ?>_modal_diocese" class="text-sm text-gray-700 space-y-1 text-center"></p>
                        <div id="<?php echo esc_attr($uniq); ?>_modal_body" class="mt-2 text-sm text-gray-700">
                        </div>
                    </div>
            </div>
